...
$search_for   = 'http://localhost/laguna_beach';  // the value you want to search for
$replace_with = 'http://www.creativamotion.com/luis/laguna_beach';  // the value to replace it with
...
while ($table_rows = mysql_fetch_array($tables_list)) {
    ...
    //if($table != 'q7fms_camera') continue;
